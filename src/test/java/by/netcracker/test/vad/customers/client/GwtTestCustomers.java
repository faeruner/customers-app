...
public class GwtTestCustomers extends GWTTestCase {
    ...
    public String getModuleName() {
        return "by.netcracker.test.vad.customers.Customers";
    }
    ...
    public void testCustomersService() {
        ...
        target.setServiceEntryPoint("/Customers/customerService");
        ...
        customerService.findByName("GWT", new AsyncCallback<List<Customer>>() {
