 ...
 * for details.
 */
public class GwtTestCustomers extends GWTTestCase {

  /**
   * Must refer to a valid module that sources this class.
   */
  public String getModuleName() {
    return "by.netcracker.test.vad.customers.CustomerJUnit";
  }
   ...
   */
  public void testCustomersService() {
    ...
    target.setServiceEntryPoint(GWT.getModuleBaseURL() + "customers/customerService");
...
//    customerService.greetServer("GWT User", new AsyncCallback<String>() {
